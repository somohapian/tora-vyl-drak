...
<span class="kt">kahu-tok</span> is the kahu's name for their own language. the compound reads kahu-talk in literal kahu-tok order. the engineered replacement language for tok-peles, the bastard tongue of the bunker era. designed by bixel during the early age of tapestry. its master lexicon, the thousand words bixel set down, is the <a class="wiki-link" href="/language/mil-tok">mil-tok</a>.
...
the language marks time without spending words on it. kahu-tok carries tense in the voice through a system of <a class="wiki-link" href="/language/tonal-tense">tonal tense</a>: a level tone is present, a rising tone is future, a falling tone is past, all on the same unchanging verb. because time rides on the verb's tone rather than occupying its own slot, the shape of an importance-first sentence is never disturbed by whether it speaks of the past, the present, or what is to come.

the language is also shaped by what it refuses to say. kahu-tok has no word for money, debt, or ownership, a set of <a class="wiki-link" href="/concepts/the-deliberate-absences">deliberate absences</a> that make the language an argument against the sovereign individual, carried in the gaps as much as in the words.
