...
word: drak
pronunciation: drahk
part_of_speech: adjective / modifier
definition: last
...
related:
  ...
  - vyl
open_canon:
  - whether drak appears in compound forms beyond tora vyl drak
  - >-
    the precise semantic range of drak (final in sequence, ultimate, most
    recent, terminal)
  - >-
    the historical reason that earlier glossaries of kahu-tok mistakenly listed
...
the precise semantic range of <span class="kt">drak</span> (whether it means last-in-sequence, ultimate-in-quality, most-recent-in-time, terminal-in-finality, or some combination) is open canon. context disambiguates in actual use.
